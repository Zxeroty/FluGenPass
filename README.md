...
FluGenPass is a modern, high-security password manager for Windows (.NET 8). It combines the elegant Fluent UI design philosophy with industry-standard cryptographic protection to keep your credentials safe and accessible.
